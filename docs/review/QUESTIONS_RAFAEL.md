...
| #2 | La déclaration de non-condamnation doit-elle être générée **par dirigeant** (Président + chaque DG dépose la sienne) ou **une seule** (celle du président, nommée) ? | **Une seule, celle du président**, avec son nom dans le fichier. Génération par DG = non ouverte. |
