...
| O24-03 | Une adresse **sans numéro de voie** (lieu-dit, place) est-elle acceptable pour ces actes, ou le **numéro est-il obligatoire** ? | **Numéro NON requis** (voie+CP+ville suffisent) — un lieu-dit reste valide. |
