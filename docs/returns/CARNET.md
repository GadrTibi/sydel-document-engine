...
| O24-03 | « Toutes les adresses doivent être rédigées sur une ligne, pas de champ séparé pour la rue, la voie, etc.. » | SELAS (UI) | — | TRIÉ | ⬜ |
...
- **Reste à faire** (Statut ≠ TRAITÉ/VALIDÉ) : `O24-02` (DISPATCHÉ, à généraliser), `O24-03`, `O24-04`, `O24-12` ; `LIVE-05`/`LIVE-06` (CLARIF).
- **En attente validation Rafael** (TRAITÉ, `Validé = ⬜`) : O24-01/05/06/07/08/09/10/11/13/14/15 + LIVE-01/02/03/04.
