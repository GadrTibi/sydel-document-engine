...
- docs/returns/DASHBOARD.md  (ÉTAT VIVANT — photo du jour, retours client)
- docs/returns/CARNET.md  (carnet des retours en cours)
- docs/returns/README.md  (mode d'emploi du bureau des retours)
- AGENTS.md
- docs/project/00_MASTER_PLAN.md
- docs/project/01_EXECUTION_BOARD.md
- docs/project/02_CODEX_WORKFLOW.md
- docs/project/03_HANDOFF_FOR_NEW_AGENT.md
- docs/project/04_LAST_STATE.md  (ARCHIVE historique figée 2026-06-03 — ne pas s'y fier pour l'état courant)
...
- mets à jour docs/project/01_EXECUTION_BOARD.md et docs/returns/DASHBOARD.md (état vivant) à la fin de chaque ticket ;
