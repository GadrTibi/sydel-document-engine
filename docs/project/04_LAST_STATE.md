...
- Le prochain ticket front recommande est `FRONT-DOCUMENTS-PANEL-001` : construire le panneau operationnel des documents attendus a partir d'un dossier partiellement saisi et de `document_status`, sans toucher aux generateurs ni au moteur DOCX/PDF/ZIP.
