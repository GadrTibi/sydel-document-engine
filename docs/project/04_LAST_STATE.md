...
Lancer `FRONT-ROLE-MODEL-001` : raffiner les roles explicites du front global a partir de la couche data creee, en priorite signataire, mandataire, representant personne morale, cedant, cessionnaire, apporteur, evaluateur, commissaire et ordre. Ne pas modifier les generateurs, le moteur DOCX/PDF/ZIP ni le prototype Streamlit. En parallele, `SELARL-JURIST-REVIEW-001` reste recommande pour la validation metier/juridique du parcours SELARL existant.
