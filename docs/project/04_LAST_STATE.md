...
Lancer `GLOBAL-FRONT-ARCHITECTURE-001` : concevoir l'architecture du nouveau front global sur `docs/project/GLOBAL_CANONICAL_FIELD_REGISTRY_V2_1.md`, sans modifier le moteur documentaire ni les générateurs. En parallèle, `SELARL-JURIST-REVIEW-001` reste recommandé pour la validation métier/juridique du parcours SELARL existant.
