...
Recommandation SELARL la plus recente : lire `docs/project/SELARL_CANONICAL_STATUS_V1.md`, puis `docs/sprints/SPRINT_SELARL_CLOSING_V1.md`. Prochaine etape officielle : `SELARL-CLOSING-PACK-001` pour regenerer le pack simple medecin/dentiste/regime communautaire et l'envoyer en revue associe / juriste.
