...
YB-S12-001 : Boss Delta Bridge documentaire. Le nouveau canon Sprint 12 est fige en docs : modele prioritaire `LEAD + ATELIER + RELANCE`, multi-bureaux autorise avec contextes separes, dossier ouvert distinct d'un lead, relances `RELANCE_TELEPRO` et `RELANCE_BOSS`, `RELANCE_BOSS` en lecture seule telepro avec messagerie autorisee, `REFAIS_AG` historise sans retour prospection brute, atelier non attribue en file manuelle, pas de role `chef telepro` et pas de logique speciale `interne / externe`. Livrables : `docs/project/Decision-Log.md`, `docs/project/Current-State.md`, `docs/project/Open-Debts-And-Risks.md`, `docs/project/Ticket-Ledger-YB.md`, `docs/spec-functional.md`, `docs/flows/Flow_Lead_Atelier_Relance_v1.md`, `docs/flows/Flow_REFAIS_AG_v2.md`, `docs/flows/Flow_Contextes_MultiBureaux_v2.md`, `docs/project/_assistant/SESSION-HANDOFF.md`, `docs/project/_assistant/CHANGE-INTENT-REGISTER.md`, `docs/project/_assistant/OPEN-LOOPS.md` et `docs/reviews/YB-S12-001-Review.md`. Pilote cobayes, Naomi, provisioning, launch et UAT reelle sont en pause. Aucun code Python, generateur, moteur DOCX/PDF/ZIP, production, design Claude, hook ou ticket pilote n'a ete lance. Prochaine etape recommandee : `YB-S12-002 Multi-contextes multi-bureaux`.
