...
- Le prochain jalon front recommande est un vrai test local utilisateur du nouveau front hard-cut sur `SELARL creation simple`, avec generation `DOC-001` a `DOC-004`, ZIP et PDF si le backend local est disponible.
