...
Lancer `FRONT-REVIEW-001` : faire valider le modele front global, les statuts documentaires et les prefills de test consolides avant tout rebuild UI visible plus large. `SELARL-JURIST-REVIEW-001` reste recommande en parallele pour la validation metier/juridique du parcours SELARL existant.
