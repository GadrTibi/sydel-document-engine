...
Lancer `FRONT-UI-SHELL-001` : creer la premiere tranche visible du nouveau front global, isoler le prototype comme bac a sable / diagnostic et poser la navigation cible avant de coder l'editeur dossier complet. `SELARL-JURIST-REVIEW-001` reste recommande en parallele pour la validation metier/juridique du parcours SELARL existant.
