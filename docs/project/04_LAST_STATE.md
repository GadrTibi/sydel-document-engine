...
Lancer `FRONT-DOSSIER-FLOW-001` : definir le flow dossier complet global a partir de la couche data, du modele de roles et du modele d'adresses, sans coder le rebuild UI visible. En parallele, `SELARL-JURIST-REVIEW-001` reste recommande pour la validation metier/juridique du parcours SELARL existant.
