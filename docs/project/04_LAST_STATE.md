...
Lancer `FRONT-DOCUMENT-STATUS-LAYER-001` : construire la couche de statuts documentaires front sur le flow dossier global, avec documents attendus, manuels, reserves, non prets, generables, document-lot et raisons de blocage. En parallele, `SELARL-JURIST-REVIEW-001` reste recommande pour la validation metier/juridique du parcours SELARL existant.
