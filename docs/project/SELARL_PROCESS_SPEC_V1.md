...
| Régime communautaire | Lettre d'avertissement au conjoint | `Lettre d'avertissement au conjoint en cas d'apport d'un bien commun.docx` | `DOC-006` | générable | `signataire`, `conjoint`, adresse du conjoint, `societe`, `apport`, `regime_communautaire.avertissement`, `signature` | Régime matrimonial / conjoint |
...
| Lettre d'avertissement au conjoint | source DOCX Lot 2 ; variables moteur `signataire`, `conjoint`, adresse du conjoint, `societe`, `apport`, `regime_communautaire.avertissement`, `signature` | Régime matrimonial / conjoint |
