...
| Documents régime communautaire | Lettre de renonciation à revendiquer la qualité d'associé ; Lettre d'avertissement au conjoint avec réserve source, car la vraie V2 indique que ce document ne figure pas parmi les sources fournies. |
...
| Régime communautaire | Lettre d'avertissement au conjoint | `Lettre d'avertissement au conjoint en cas d'apport d'un bien commun.docx` | `DOC-006` | générable moteur avec réserve source V2 | aucune variable fournie dans la vraie V2 ; variables moteur historiques `signataire`, `conjoint`, `societe`, `apport`, `regime_communautaire.avertissement`, `signature` à confirmer avant pilote | Régime matrimonial / conjoint |
...
|---|---|---|
| Déclaration sur l'honneur de non-condamnation | `[civilite]`, `[prenom]`, `[nom]`, `[date_naissance]`, `[num_voie_perso]`, `[voie_perso]`, `[cp_perso]`, `[ville_perso]`, `[nationalite]`, `[nom_pere]`, `[nom_mere]`, `[lieu_signature]`, `[date_signature]` | Professionnel / gérant ; Signature |
...
| Lettre d'avertissement au conjoint | aucune variable fournie ; la V2 précise que le document ne figure pas parmi les sources fournies | Régime matrimonial / conjoint |
